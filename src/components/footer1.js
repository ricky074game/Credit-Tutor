      ...
      <div className="footer1-max-width thq-section-max-width">
            ...
            <div className="footer1-column3">
              ...
              <div className="footer1-social-links">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="footer1-link02"
                >
                  <div className="footer1-link03">
                    <svg
                      viewBox="0 0 877.7142857142857 1024"
                      className="thq-icon-small"
                    >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="footer1-link04"
                >
                  <div className="footer1-link05">
                    <svg
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer noopener"
                  className="footer1-link06"
                >
                  <div className="footer1-link07">
                    <svg
                      viewBox="0 0 877.7142857142857 1024"
                      className="thq-icon-small"
                    >
        ...
        <div className="footer1-credits">
          ...
          <div className="footer1-row">
            <div className="footer1-footer-links2"></div>
          </div>
        </div>
      </div>
    </footer>
...
Footer1.defaultProps = {
  column1Title: 'Easy links',
  link8: 'Política de privacidad',
  link4: 'FREE MONEY',
  link2: 'Gmail',
  link6: 'Home',
  column2Title: 'Links',
  link9: 'Términos y condiciones',
  link3: 'Instagram',
  rootClassName: '',
  socialLinkTitleCategory: 'Social (Able to be changed)',
  link7: 'List of services',
  link1: 'Google',
}
